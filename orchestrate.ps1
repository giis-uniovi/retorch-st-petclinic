...
$RootPackageNameTests = "giis.petclinic.e2e.functional.tests"
...
# Example of a command java -jar retorch-orchestration-1.2.1-60-creation-of-a-tool-cli-with-retorch-orchestration-20260527.130705-3-standalone.jar "giis.petclinic.e2e.functional.tests" "PetClinic" "./"