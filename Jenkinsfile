        ...
        stage('tjobc IdResource: frontend owner web-browser ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              ...
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobc 0 http://tjobc-api-gateway:8080 "TestOwners#createNewPetOwner,TestOwners#editPetOwner,TestOwners#searchPetOwner"'
        ...
        stage('tjobe IdResource: frontend web-browser ') {
          steps {
            catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
              ...
              sh '$SCRIPTS_FOLDER/tjoblifecycles/tjob-testexecution.sh tjobe 1 http://tjobe-api-gateway:8080 "TestNavigation#navigationFrontend"'
